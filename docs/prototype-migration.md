...
| Main world v0.19 | World screen and action API | Street interaction v0.1 implemented across Market Street, Cypress Avenue and Mira Alley |
...
| Finance v0.1.1 | Ledger/accounts service and React feature | Core end-to-end slice implemented; integration regression active |
