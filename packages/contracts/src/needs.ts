...
export const InjurySchema = z.object({
  ...
  bodyArea: InjuryBodyAreaSchema,
  severity: InjurySeveritySchema,
  bleeding: BleedingSeveritySchema,
  treated: z.boolean(),
  recoveryUntil: z.iso.datetime().nullable(),
  createdAt: z.iso.datetime()
});

export const NeedsStatusSchema = z.object({
  consciousness: ConsciousnessSchema,
  careState: CareStateSchema,
  ...
  canRest: z.boolean(),
  canSleep: z.boolean(),
  primaryResidenceRequired: z.boolean(),
  admittedUntil: z.iso.datetime().nullable(),
  injuries: z.array(InjurySchema),
  lastSimulatedAt: z.iso.datetime()
});

export const NeedsStateSchema = z.object({
  status: NeedsStatusSchema,
  hud: z.object({
...
export const NeedsMutationResultSchema = z.object({
  needs: NeedsStateSchema,
  noticeBg: z.string(),
  noticeEn: z.string()
});

export type NeedsState = z.infer<typeof NeedsStateSchema>;
export type InjuryKind = z.infer<typeof InjuryKindSchema>;
export type InjuryBodyArea = z.infer<typeof InjuryBodyAreaSchema>;
export type RestKind = z.infer<typeof RestRequestSchema>['kind'];
