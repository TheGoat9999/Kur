...
export const CHARACTER_CATALOG: CharacterCatalogItem[] = [
  ...
  item('fade-textured','hair','Къса текстурирана прическа','Textured fade','short textured fade haircut',['male','unisex'],['street','modern'],'#2b211c','#171311','fade'),
  item('buzz-clean','hair','Много къса подстрижка','Clean buzz cut','clean short buzz cut',['male','unisex'],['minimal','sport'],'#2c211b','#171311','buzz'),
  ...
  item('cornrows-back','hair','Плитки назад','Cornrows back','tight cornrows swept back',['unisex'],['street','sport'],'#211814','#100d0b','cornrows'),
  ...
  item('long-layered','hair','Дълга коса на пластове','Long layered','long layered hair with soft volume',['female','unisex'],['fashion'],'#3b2920','#171311','long'),
  ...
  item('undercut-swept','hair','Къси страни с дълъг връх','Side-swept undercut','side-swept undercut with textured top',['male','unisex'],['modern','luxury'],'#33231d','#171311','undercut'),

  item('clean','facialHair','Без брада','Clean shaven','clean shaven face',['male','unisex'],['clean'],'#000000','#000000','none'),
  item('stubble','facialHair','Лека набола брада','Light stubble','short even designer stubble',['male'],['street','modern'],'#2a211c','#171311','stubble'),
  item('boxed-beard','facialHair','Поддържана къса брада','Boxed beard','well-groomed short boxed beard',['male'],['classic','luxury'],'#2a211c','#171311','beard'),
  ...
  item('tee-cream','top','Кремава широка тениска','Cream tee','heavyweight cream oversized t-shirt',['unisex'],['street','clean'],'#d8c8ae','#eee0c9','tee'),
  item('tank-white','top','Бял потник','White tank','clean white ribbed tank top',['unisex'],['sport','street'],'#e8e7e1','#c7c6bf','tank'),
  item('shirt-open-blue','top','Синя риза с отворена яка','Open blue shirt','relaxed blue open-collar shirt',['unisex'],['casual','coastal'],'#345f82','#88a9c2','shirt'),
  item('hoodie-graphite','top','Графитена горна дреха с качулка','Graphite hoodie','premium graphite oversized hoodie',['unisex'],['street','sport'],'#33383f','#171a1d','hoodie'),
  item('crop-black','top','Черна къса блуза','Black crop top','fitted black cropped top',['female'],['fashion','nightlife'],'#18191b','#383b40','crop'),
  ...
  item('bomber-olive','outerwear','Маслинено късо яке','Olive bomber','olive green cropped bomber jacket',['unisex'],['street','utility'],'#4e5945','#222820','bomber'),
  ...
  item('varsity-sd','outerwear','Университетско яке SOL DORADO','SOL DORADO varsity','navy and gold varsity jacket with subtle Sol Dorado insignia',['unisex'],['street','campus'],'#162d49','#d1a447','varsity'),
  item('blazer-sand','outerwear','Пясъчно сако','Sand blazer','relaxed sand-colored tailored blazer',['unisex'],['luxury','coastal'],'#b89b77','#ede1cf','blazer'),
  item('puffer-black','outerwear','Черно пухено яке','Black puffer','matte black cropped puffer jacket',['unisex'],['street','winter'],'#191d21','#353c43','puffer'),

  item('cargo-charcoal','bottoms','Графитен карго панталон','Charcoal cargo','charcoal utility cargo pants',['unisex'],['street','utility'],'#2c3338','#161a1d','cargo'),
  ...
  item('trousers-black','bottoms','Черни елегантни панталони','Black trousers','clean black tailored trousers',['unisex'],['luxury','minimal'],'#181a1d','#33363a','trousers'),
  item('shorts-utility','bottoms','Къси панталони с джобове','Utility shorts','dark utility shorts with structured pockets',['unisex'],['street','summer'],'#394047','#1f2428','shorts'),
  ...
  item('sneakers-white','shoes','Бели спортни обувки','White sneakers','clean premium white low-top sneakers',['unisex'],['street','clean'],'#e9e9e5','#a9adb1','sneakers'),
  item('sneakers-black','shoes','Черни спортни обувки','Black sneakers','matte black low-top sneakers',['unisex'],['street','minimal'],'#17191b','#35383d','sneakers'),
  item('boots-combat','shoes','Черни високи кубинки','Black combat boots','black lace-up combat boots',['unisex'],['utility','street'],'#191815','#39342e','boots'),
  item('loafers-brown','shoes','Кафяви кожени обувки','Brown loafers','polished dark brown leather loafers',['unisex'],['luxury','classic'],'#4f3425','#9b7558','loafers'),
  ...
  item('glasses-clear','eyewear','Очила с прозрачна рамка','Clear glasses','thin clear-frame optical glasses',['unisex'],['clean','creative'],'#d8e0e5','#7a8993','glasses'),
  ...
  item('aviators-gold','eyewear','Златни пилотски очила','Gold aviators','gold metal aviator sunglasses',['unisex'],['luxury','coastal'],'#c9a24a','#362d20','aviators'),

  item('none','headwear','Без шапка','No headwear','no headwear',['unisex'],['none'],'#000000','#000000','none'),
  item('cap-black','headwear','Черна шапка с козирка','Black cap','black structured baseball cap',['unisex'],['street','sport'],'#15181b','#353a40','cap'),
  item('bucket-sand','headwear','Пясъчна шапка с периферия','Sand bucket hat','sand-colored bucket hat',['unisex'],['street','summer'],'#b8a184','#e1d3bf','bucket'),
  item('beanie-charcoal','headwear','Графитена плетена шапка','Charcoal beanie','charcoal rib-knit beanie',['unisex'],['street','winter'],'#34383d','#17191c','beanie'),
  ...
  item('bag-crossbody','accessory','Малка чанта през рамо','Crossbody bag','compact black crossbody utility bag',['unisex'],['street','utility'],'#202428','#4c535a','bag')
];
