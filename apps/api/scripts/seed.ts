...
try {
  ...
  await db.query(`
    ...
    VALUES
      ...
      ('00000000-0000-4000-8000-000000000309', $1, '00000000-0000-4000-8000-000000000201', 'compact_pistol', 'Compact Pistol', 'Weapon', 'WP', 1, 760, false, 6, '{"condition":85,"equipped":false,"loadedRounds":0}'),
      ('00000000-0000-4000-8000-000000000310', $1, '00000000-0000-4000-8000-000000000201', 'ammo_9mm', '9mm Ammunition', 'Weapon', '9MM', 45, 15, true, 7, '{}'),
      ('00000000-0000-4000-8000-000000000311', $1, '00000000-0000-4000-8000-000000000201', 'weapon_parts_kit', 'Weapon Parts Kit', 'Material', 'WPK', 2, 650, true, 8, '{}'),
      ('00000000-0000-4000-8000-000000000312', $1, '00000000-0000-4000-8000-000000000201', 'ammo_components_box', 'Ammunition Components Box', 'Material', 'ACB', 1, 900, true, 9, '{}'),
      ('00000000-0000-4000-8000-000000000313', $1, '00000000-0000-4000-8000-000000000201', 'precision_hardware_pack', 'Precision Hardware Pack', 'Material', 'PHP', 1, 420, true, 10, '{}'),
      ('00000000-0000-4000-8000-000000000314', $1, '00000000-0000-4000-8000-000000000201', 'cloth_scraps', 'Cloth Scraps', 'Material', 'CLT', 2, 500, true, 11, '{}'),
      ('00000000-0000-4000-8000-000000000315', $1, '00000000-0000-4000-8000-000000000201', 'adhesive', 'Industrial Adhesive', 'Material', 'ADH', 1, 900, true, 12, '{}'),
